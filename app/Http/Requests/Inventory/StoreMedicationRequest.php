...
class StoreMedicationRequest extends FormRequest
{
     ...
     *
     * `current_stock` is intentionally not an accepted key: a medication is
     * always created with zero stock. Any initial quantity must be
     * registered afterward as an Entry movement through
